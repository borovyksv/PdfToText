...
public class DocumentWithTextPagesRepositoryTest {
    ...
    DocumentWithTextPages doc1, doc2, doc3;
    ...
    public void setsIdOnSave() {
        ...
        DocumentWithTextPages test = repository.save(getDocument("TEST 4"));
    ...
    public void findsByName() {
        ...
        DocumentWithTextPages test = repository.findByName("TEST 2");
    ...
    @Ignore
    private DocumentWithTextPages getDocument(String name) {
